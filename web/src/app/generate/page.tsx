  ...
  if (pipeline.phase === "idle" && !finalVideoUrl && !scriptData) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h3 className="font-headline font-extrabold text-xl text-on-surface mb-2">No Video to Generate</h3>
      ...
      <div className="flex-1 overflow-y-auto w-full custom-scrollbar">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-12 gap-6 pb-20">
            ...
            {/* Scenes List */}
            <div className="col-span-12 lg:col-span-4 space-y-4 lg:h-[calc(100vh-280px)] min-h-[400px] flex flex-col">
                  ...
                  return (
                    ...
                    >
                      <div className="w-20 h-14 rounded-lg overflow-hidden bg-surface-container-lowest relative flex-shrink-0">
                        { (status?.imageUrl || (status as any)?.imageUrls?.[0]) ? (
                          <img src={status?.imageUrl || (status as any)?.imageUrls?.[0]} alt={`Scene ${i + 1}`} className="w-full h-full object-cover" />
                        ) : (
