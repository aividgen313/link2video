  ...
  const NavContent = () => (
    <>
      ...
      <button
        ...
        className="w-12 h-12 rounded-[1.25rem] bg-primary flex items-center justify-center mb-6 hover:scale-110 press-scale transition-all duration-500 shadow-lg shadow-primary/25 group relative group"
      >
