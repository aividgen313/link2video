    ...
    <div className="flex flex-col gap-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <h1 className="text-4xl md:text-6xl font-headline font-black text-on-surface tracking-tight">Project Assets</h1>
          <p className="text-on-surface-variant font-body max-w-lg">
            Manage your AI-generated clips and manual uploads. Organized by project history.
          </p>
        </div>
        <button
          onClick={() => fileInputRef.current?.click()}
          className="flex items-center gap-3 bg-primary text-on-primary px-8 py-4 rounded-2xl font-headline font-bold shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
